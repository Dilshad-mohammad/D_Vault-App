...
class DProductCardHorizontal extends StatelessWidget {
  const DProductCardHorizontal({super.key, required this.product, this.isNetworkImage = true});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: DHelperFunctions.isDarkMode(context) ? TColors.darkerGrey : TColors.lightContainer,
        ),
        child: Row(
          ...
          children: [
            ...
            DRoundedContainer(
              ...
              child: Stack(
                children: [
                  /// -- Thumbnail Image
                  DRoundedImage(width: 120, height: 120, imageUrl: product.thumbnail, isNetworkImage: isNetworkImage),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: DSizes.spaceBtwItems / 2),
                        DBrandTitleWithVerifiedIcon(title: product.brand!.name, brandTextSize: TextSizes.small),
                      ],
                    ),
                  ),
