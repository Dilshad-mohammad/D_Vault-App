...
class OrderModel {
  ...
  String get formattedOrderDate => DHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate => deliveryDate != null ? DHelperFunctions.getFormattedDate(deliveryDate!) : '';
