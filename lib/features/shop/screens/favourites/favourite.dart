          ...
          child: Padding(
            ...
            child: Column(
              children: [
                  ...
                  return FutureBuilder(
                    ...
                    builder: (_, snapshot) {
                      ...
                      final emptyWidget = DAnimationLoaderWidget(
                        ...
                        animation: DImages.pencilAnimation,
                        showAction: true,
                        actionText: 'Let\'s add some',
                        onActionPressed: () => Get.off(() => const HomeMenu()),
                      );
                      const loader = DVerticalProductShimmer(itemCount: 6);
                      final widget = DCloudHelperFunctions.checkMultiRecordState(snapshot: snapshot, loader: loader, nothingFound: emptyWidget);
                ...
                SizedBox(height: DDeviceUtils.getBottomNavigationBarHeight() + DSizes.defaultSpace),
              ],
            ),
          ),
        ),
