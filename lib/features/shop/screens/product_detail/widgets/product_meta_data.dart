      ...
      children: [
              ...
              Row(
                children: [
                  DRoundedContainer(
                    ...
                    radius: DSizes.sm,
                    padding: const EdgeInsets.symmetric(horizontal: DSizes.sm, vertical: DSizes.xs),
        ...
        Row(
          children: [
            ...
            DBrandTitleWithVerifiedIcon(title: product.brand!.name, brandTextSize: TextSizes.medium),
          ],
        ),
      ],
    );
