      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            /// 2 - Product Details
            Container(
              padding: const EdgeInsets.only(right: DSizes.defaultSpace, left: DSizes.defaultSpace, bottom: DSizes.defaultSpace),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  /// - Rating & Share
                  ...
                  if (product.productVariations != null && product.productVariations!.isNotEmpty) DProductAttributes(product: product),
                  if (product.productVariations != null && product.productVariations!.isNotEmpty) const SizedBox(height: DSizes.spaceBtwSections),
