...
class TDummyData {
  ...
  static final List<BannerModel> banners = [
    BannerModel(imageUrl: DImages.banner1, targetScreen: DRoutes.order, active: false),
    BannerModel(imageUrl: DImages.banner2, targetScreen: DRoutes.cart, active: true),
    BannerModel(imageUrl: DImages.banner3, targetScreen: DRoutes.favourites, active: true),
    BannerModel(imageUrl: DImages.banner4, targetScreen: DRoutes.search, active: true),
    BannerModel(imageUrl: DImages.banner5, targetScreen: DRoutes.settings, active: true),
    BannerModel(imageUrl: DImages.banner6, targetScreen: DRoutes.userAddress, active: true),
    BannerModel(imageUrl: DImages.banner8, targetScreen: DRoutes.checkout, active: false),
  ];
  ...
  static final UserModel user = UserModel(
    firstName: 'Dilshad',
    lastName: 'Alam',
    email: 'Dilshadalam014@gmail.com',
    phoneNumber: '+918318163744',
  ...
  static final List<CategoryModel> categories = [
    CategoryModel(id: '1', image: DImages.sportIcon, name: 'Sports', isFeatured: true),
    CategoryModel(id: '5', image: DImages.furnitureIcon, name: 'Furniture', isFeatured: true),
    CategoryModel(id: '3', image: DImages.clothIcon, name: 'Clothes', isFeatured: true),
    CategoryModel(id: '4', image: DImages.animalIcon, name: 'Animals', isFeatured: true),
    CategoryModel(id: '6', image: DImages.shoeIcon, name: 'Shoes', isFeatured: true),
    CategoryModel(id: '7', image: DImages.cosmeticsIcon, name: 'Cosmetics', isFeatured: true),
    CategoryModel(id: '14', image: DImages.jeweleryIcon, name: 'Jewelery', isFeatured: true),

    ///subcategories
    CategoryModel(id: '8', image: DImages.sportIcon, name: 'Sport Shoes', parentId: '1', isFeatured: false),
    CategoryModel(id: '9', image: DImages.sportIcon, name: 'Track suits', parentId: '1', isFeatured: false),
    CategoryModel(id: '10', image: DImages.sportIcon, name: 'Sports Equipments', parentId: '1', isFeatured: false),
    //furniture
    CategoryModel(id: '11', image: DImages.furnitureIcon, name: 'Bedroom furniture', parentId: '5', isFeatured: false),
    CategoryModel(id: '12', image: DImages.furnitureIcon, name: 'Kitchen furniture', parentId: '5', isFeatured: false),
    CategoryModel(id: '13', image: DImages.furnitureIcon, name: 'Office furniture', parentId: '5', isFeatured: false),
    //electronics
    CategoryModel(id: '14', image: DImages.electronicsIcon, name: 'Laptop', parentId: '2', isFeatured: false),
    CategoryModel(id: '15', image: DImages.electronicsIcon, name: 'Mobile', parentId: '2', isFeatured: false),

    CategoryModel(id: '16', image: DImages.clothIcon, name: 'Shirts', parentId: '3', isFeatured: false),
  ];

  /// -- List of all Brands
  static final List<BrandModel> brands = [
    BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike', productsCount: 265, isFeatured: true),
    BrandModel(id: '2', image: DImages.adidasLogo, name: 'Adidas', productsCount: 95, isFeatured: true),
    BrandModel(id: '8', image: DImages.kenwoodLogo, name: 'Kenwood', productsCount: 36, isFeatured: false),
    BrandModel(id: '9', image: DImages.ikeaLogo, name: 'IKEA', productsCount: 36, isFeatured: false),
    BrandModel(id: '5', image: DImages.appleLogo, name: 'Apple', productsCount: 16, isFeatured: true),
    BrandModel(id: '10', image: DImages.acerlogo, name: 'Acer', productsCount: 36, isFeatured: false),
    BrandModel(id: '3', image: DImages.jordanLogo, name: 'Jordan', productsCount: 36, isFeatured: true),
    BrandModel(id: '4', image: DImages.pumaLogo, name: 'Puma', productsCount: 65, isFeatured: true),
    BrandModel(id: '6', image: DImages.zaraLogo, name: 'ZARA', productsCount: 36, isFeatured: true),
    BrandModel(id: '7', image: DImages.electronicsIcon, name: 'Samsung', productsCount: 36, isFeatured: false),
  ];
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      price: 135,
      isFeatured: true,
      thumbnail: DImages.productImage1,
      description: 'Green Nike sports shoe',
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike', productsCount: 265, isFeatured: true),
      images: [DImages.productImage1, DImages.productImage23, DImages.productImage21, DImages.productImage9],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '1',
      productAttributes: [
      ...
      productVariations: [
        ...
        ProductVariationModel(
            id: '2', stock: 15, price: 132, image: DImages.productImage23, attributeValues: {'Color': 'Black', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '3', stock: 0, price: 234, image: DImages.productImage23, attributeValues: {'Color': 'Black', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '4', stock: 222, price: 232, image: DImages.productImage1, attributeValues: {'Color': 'Green', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '5', stock: 0, price: 334, image: DImages.productImage21, attributeValues: {'Color': 'Red', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 332, image: DImages.productImage21, attributeValues: {'Color': 'Red', 'Size': 'EU 32'}),
      ],
    ...
    ProductModel(
      ...
      price: 35,
      isFeatured: true,
      thumbnail: DImages.productImage69,
      description:
          'This is a Product description for Blue Nike Sleeve less vest. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '6', image: DImages.zaraLogo, name: 'ZARA'),
      images: [DImages.productImage68, DImages.productImage69, DImages.productImage5],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '16',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 38000,
      isFeatured: false,
      thumbnail: DImages.productImage64,
      description:
      ...
      brand: BrandModel(id: '6', image: DImages.zaraLogo, name: 'ZARA'),
      images: [DImages.productImage64, DImages.productImage65, DImages.productImage66, DImages.productImage67],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '16',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 135,
      isFeatured: false,
      thumbnail: DImages.productImage60,
      description:
      ...
      brand: BrandModel(id: '6', image: DImages.zaraLogo, name: 'ZARA'),
      images: [DImages.productImage60, DImages.productImage61, DImages.productImage62, DImages.productImage63],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '16',
      productAttributes: [
      ...
      productVariations: [
        ProductVariationModel(
            ...
            price: 134,
            salePrice: 122.6,
            image: DImages.productImage60,
            description: 'This is a Product description for 4 Color collar t-shirt dry fit',
            attributeValues: {'Color': 'Red', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '2', stock: 15, price: 132, image: DImages.productImage60, attributeValues: {'Color': 'Red', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '3', stock: 0, price: 234, image: DImages.productImage61, attributeValues: {'Color': 'Yellow', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '4', stock: 222, price: 232, image: DImages.productImage61, attributeValues: {'Color': 'Yellow', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '5', stock: 0, price: 334, image: DImages.productImage62, attributeValues: {'Color': 'Green', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 332, image: DImages.productImage62, attributeValues: {'Color': 'Green', 'Size': 'EU 30'}),
        ProductVariationModel(
            id: '7', stock: 0, price: 334, image: DImages.productImage63, attributeValues: {'Color': 'Blue', 'Size': 'EU 30'}),
        ProductVariationModel(
            id: '8', stock: 11, price: 332, image: DImages.productImage63, attributeValues: {'Color': 'Blue', 'Size': 'EU 34'}),
      ],
      productType: ProductType.variable.toString(),
    ),
    ...
    ProductModel(
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike', productsCount: 265, isFeatured: true),
      images: [DImages.productImage7, DImages.productImage8, DImages.productImage9, DImages.productImage10],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '8',
      productAttributes: [
      ...
      productVariations: [
        ...
        ProductVariationModel(
            id: '2', stock: 15, price: 35, image: DImages.productImage7, attributeValues: {'Color': 'Black', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '3', stock: 14, price: 34, image: DImages.productImage9, attributeValues: {'Color': 'Brown', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '4', stock: 13, price: 33, image: DImages.productImage7, attributeValues: {'Color': 'Black', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '5', stock: 12, price: 32, image: DImages.productImage9, attributeValues: {'Color': 'Brown', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 31, image: DImages.productImage8, attributeValues: {'Color': 'Orange', 'Size': 'EU 32'}),
      ],
      productType: ProductType.variable.toString(),
    ),
    ProductModel(
      ...
      price: 750,
      isFeatured: false,
      thumbnail: DImages.productImage11,
      description: 'SAMSUNG Galaxy S9 (Pink, 64 GB)  (4 GB RAM), Long Battery timing',
      brand: BrandModel(id: '7', image: DImages.appleLogo, name: 'Samsung'),
      images: [DImages.productImage11, DImages.productImage12, DImages.productImage13, DImages.productImage12],
      salePrice: 650,
      sku: 'ABR4568',
      categoryId: '2',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 20,
      isFeatured: false,
      thumbnail: DImages.productImage18,
      description:
      ...
      brand: BrandModel(id: '7', image: DImages.appleLogo, name: 'Tomi'),
      salePrice: 10,
      sku: 'ABR4568',
      categoryId: '4',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 400,
      isFeatured: false,
      thumbnail: DImages.productImage19,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage19, DImages.productImage20, DImages.productImage21, DImages.productImage22],
      salePrice: 200,
      sku: 'ABR4568',
      categoryId: '8',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: DImages.productImage20,
      description:
          'This is a Product description for Nike Air Jordon. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage20, DImages.productImage23, DImages.productImage21, DImages.productImage22],
      // salePrice: 200,
      sku: 'ABR4568',
      categoryId: '8',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 600,
      isFeatured: true,
      thumbnail: DImages.productImage21,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage21, DImages.productImage20, DImages.productImage19, DImages.productImage22],
      salePrice: 400,
      sku: 'ABR4568',
      categoryId: '8',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 600,
      isFeatured: false,
      thumbnail: DImages.productImage22,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage22, DImages.productImage20, DImages.productImage21, DImages.productImage23],
      salePrice: 400,
      sku: 'ABR4568',
      categoryId: '8',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 600,
      isFeatured: false,
      thumbnail: DImages.productImage23,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage23, DImages.productImage20, DImages.productImage21, DImages.productImage22],
      salePrice: 400,
      sku: 'ABR4568',
      categoryId: '8',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 500,
      isFeatured: true,
      thumbnail: DImages.productImage26,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage26, DImages.productImage24, DImages.productImage25, DImages.productImage27],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '9',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 200,
      thumbnail: DImages.productImage24,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage24, DImages.productImage26, DImages.productImage25, DImages.productImage27],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '9',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 100,
      thumbnail: DImages.productImage25,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage25, DImages.productImage24, DImages.productImage26, DImages.productImage27],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '9',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 350,
      thumbnail: DImages.productImage27,
      description:
      ...
      brand: BrandModel(id: '1', image: DImages.nikeLogo, name: 'Nike'),
      images: [DImages.productImage27, DImages.productImage24, DImages.productImage25, DImages.productImage26],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '9',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 40,
      isFeatured: true,
      thumbnail: DImages.productImage28,
      description:
      ...
      brand: BrandModel(id: '2', image: DImages.adidasLogo, name: 'Adidas'),
      images: [DImages.productImage28, DImages.productImage29, DImages.productImage30, DImages.productImage31],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '10',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 30,
      thumbnail: DImages.productImage29,
      description:
      ...
      brand: BrandModel(id: '2', image: DImages.adidasLogo, name: 'Adidas'),
      images: [DImages.productImage29, DImages.productImage28, DImages.productImage30, DImages.productImage31],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '10',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 25,
      thumbnail: DImages.productImage30,
      description:
      ...
      brand: BrandModel(id: '2', image: DImages.adidasLogo, name: 'Adidas'),
      images: [DImages.productImage30, DImages.productImage29, DImages.productImage28, DImages.productImage31],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '10',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 54,
      thumbnail: DImages.productImage31,
      description:
      ...
      brand: BrandModel(id: '2', image: DImages.adidasLogo, name: 'Adidas'),
      images: [DImages.productImage31, DImages.productImage29, DImages.productImage30, DImages.productImage28],
      // salePrice: 400,1
      sku: 'ABR4568',
      categoryId: '10',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 950,
      isFeatured: true,
      thumbnail: DImages.productImage32,
      description:
          'Flutter is Google’s mobile UI open source framework to build high-quality native (super fast) interfaces for iOS and Android apps with the unified codebase.',
      brand: BrandModel(id: '8', image: DImages.kenwoodLogo, name: 'Kenwood'),
      images: [DImages.productImage43, DImages.productImage44, DImages.productImage45, DImages.productImage46],
      salePrice: 600,
      sku: 'ABR4568',
      categoryId: '11',
      productAttributes: [
      ...
      productVariations: [
        ProductVariationModel(
            ...
            price: 36,
            salePrice: 12.6,
            image: DImages.productImage32,
            description:
                'Flutter is Google’s mobile UI open source framework to build high-quality native (super fast) interfaces for iOS and Android apps with the unified codebase.',
            attributeValues: {'Color': 'Brown', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '2', stock: 15, price: 35, image: DImages.productImage45, attributeValues: {'Color': 'Brown', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '3', stock: 14, price: 34, image: DImages.productImage46, attributeValues: {'Color': 'Brown', 'Size': 'EU 30'}),
        ProductVariationModel(
            id: '4', stock: 13, price: 33, image: DImages.productImage43, attributeValues: {'Color': 'Black', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '5', stock: 12, price: 32, image: DImages.productImage43, attributeValues: {'Color': 'Black', 'Size': 'EU 34'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 31, image: DImages.productImage44, attributeValues: {'Color': 'Grey', 'Size': 'EU 32'}),
      ],
      productType: ProductType.variable.toString(),
    ),
    ProductModel(
      ...
      stock: 15,
      price: 25,
      thumbnail: DImages.productImage33,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 25,
      thumbnail: DImages.productImage34,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 56,
      thumbnail: DImages.productImage35,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 1012,
      thumbnail: DImages.productImage36,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 1012,
      thumbnail: DImages.productImage37,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 987,
      thumbnail: DImages.productImage38,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 150,
      thumbnail: DImages.productImage39,
      description:
      ...
      brand: BrandModel(id: '9', image: DImages.ikeaLogo, name: 'IKEA'),
      // salePrice: 400,1
      sku: 'ABR4568',
      categoryId: '13',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 140,
      thumbnail: DImages.productImage40,
      description:
          'This is a Product description for Office Chair. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '9', image: DImages.ikeaLogo, name: 'IKEA'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 360,
      thumbnail: DImages.productImage41,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: DImages.productImage42,
      description:
          'This is a Product description for Office Desk. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '9', image: DImages.ikeaLogo, name: 'IKEA'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      price: 950,
      isFeatured: true,
      thumbnail: DImages.productImage56,
      description:
      ...
      brand: BrandModel(id: '10', image: DImages.acerlogo, name: 'Acer'),
      images: [DImages.productImage56, DImages.productImage47, DImages.productImage57, DImages.productImage58],
      salePrice: 800,
      sku: 'ABR4568',
      categoryId: '14',
      productAttributes: [
      ...
      productVariations: [
        ProductVariationModel(
            ...
            price: 400,
            salePrice: 350,
            image: DImages.productImage56,
            description:
                'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
            attributeValues: {'Ram': '6', 'hard': '512'}),
        ProductVariationModel(id: '2', stock: 15, price: 450, image: DImages.productImage47, attributeValues: {'Ram': '8', 'hard': '512'}),
        ProductVariationModel(id: '3', stock: 14, price: 470, image: DImages.productImage59, attributeValues: {'Ram': '8', 'hard': '1 tb'}),
        ProductVariationModel(id: '4', stock: 13, price: 500, image: DImages.productImage58, attributeValues: {'Ram': '16', 'hard': '512'}),
        ProductVariationModel(
            id: '5', stock: 12, price: 650, image: DImages.productImage57, attributeValues: {'Ram': '16', 'hard': '1 tb'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 800, image: DImages.productImage59, attributeValues: {'Ram': '16', 'hard': '2 tb'}),
      ],
      productType: ProductType.variable.toString(),
    ),
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: DImages.productImage48,
      description:
          'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '10', image: DImages.acerlogo, name: 'Acer'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: DImages.productImage49,
      description:
          'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '10', image: DImages.acerlogo, name: 'Acer'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: DImages.productImage50,
      description:
          'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '10', image: DImages.acerlogo, name: 'Acer'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 999,
      thumbnail: DImages.productImage51,
      description:
      ...
      brand: BrandModel(id: '5', image: DImages.appleLogo, name: 'Apple'),
      // salePrice: 400,1
      sku: 'ABR4568',
      categoryId: '15',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 999,
      thumbnail: DImages.productImage52,
      description:
          'This is a Product description for Iphone. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '5', image: DImages.appleLogo, name: 'Apple'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 999,
      thumbnail: DImages.productImage53,
      description:
          'This is a Product description for Iphone. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '5', image: DImages.appleLogo, name: 'Apple'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      price: 950,
      isFeatured: true,
      thumbnail: DImages.productImage70,
      description:
      ...
      brand: BrandModel(id: '5', image: DImages.appleLogo, name: 'Apple'),
      images: [DImages.productImage70, DImages.productImage71, DImages.productImage72, DImages.productImage73],
      salePrice: 800,
      sku: 'ABR4568',
      categoryId: '15',
      productAttributes: [
      ...
      productVariations: [
        ProductVariationModel(
            ...
            price: 400,
            salePrice: 350,
            image: DImages.productImage70,
            description:
                'This is a Product description for Iphone 12. There are more things that can be added but i am just practicing and nothing else.',
            attributeValues: {'Color': 'Red', 'Storage': '128 gb'}),
        ProductVariationModel(
            id: '2', stock: 15, price: 450, image: DImages.productImage70, attributeValues: {'Color': 'Red', 'Storage': '256 gb'}),
        ProductVariationModel(
            id: '3', stock: 14, price: 470, image: DImages.productImage71, attributeValues: {'Color': 'Blue', 'Storage': '128 gb'}),
        ProductVariationModel(
            id: '4', stock: 13, price: 500, image: DImages.productImage71, attributeValues: {'Color': 'Blue', 'Storage': '256 gb'}),
        ProductVariationModel(
            id: '5', stock: 12, price: 650, image: DImages.productImage72, attributeValues: {'Color': 'Green', 'Storage': '128 gb'}),
        ProductVariationModel(
            id: '5', stock: 12, price: 650, image: DImages.productImage72, attributeValues: {'Color': 'Green', 'Storage': '256 gb'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 800, image: DImages.productImage73, attributeValues: {'Color': 'Black', 'Storage': '128 gb'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 800, image: DImages.productImage73, attributeValues: {'Color': 'Black', 'Storage': '256 gb'}),
      ],
      productType: ProductType.variable.toString(),
    ),
    ProductModel(
      ...
      price: 480,
      isFeatured: true,
      thumbnail: DImages.productImage14,
      description:
      ...
      brand: BrandModel(id: '5', image: DImages.appleLogo, name: 'iphone 8'),
      images: [DImages.productImage15, DImages.productImage16, DImages.productImage17, DImages.productImage14],
      salePrice: 380,
      sku: 'ABR4568',
      categoryId: '4',
      productAttributes: [
  ...
  static final List<ProductReviewModel> productReviews = [
    ProductReviewModel(
      ...
      userImageUrl: DImages.userProfileImage2,
    ...
    ProductReviewModel(
      ...
      timestamp: DateTime.now(),
      companyTimestamp: DateTime.now(),
      userImageUrl: DImages.userProfileImage1,
      comment:
    ...
    ProductReviewModel(
      ...
      timestamp: DateTime.now(),
      companyTimestamp: DateTime.now(),
      userImageUrl: DImages.userProfileImage3,
