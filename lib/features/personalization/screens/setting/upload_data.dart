...
class UploadDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const DAppBar(title: Text('Upload Data'), showBackArrow: true),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const DSectionHeading(title: 'Main Record', showActionButton: false),
                  ...
                  const DSectionHeading(title: 'Relationships', showActionButton: false),
