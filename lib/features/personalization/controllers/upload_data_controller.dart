...
class UploadDataController extends GetxController {
  ...
  Future<void> uploadCategories() async {
    try {
      ...
      DFullScreenLoader.openLoadingDialog('Sit Tight! Your CATEGORIES are uploading...', DImages.cloudUploadingAnimation);
  ...
  Future<void> uploadProductCategories() async {
    try {
      ...
      DFullScreenLoader.openLoadingDialog(
        ...
        DImages.cloudUploadingAnimation,
      );
  ...
  Future<void> uploadBrands() async {
    try {
      ...
      DFullScreenLoader.openLoadingDialog('Sit Tight! Your BRANDS are uploading...', DImages.cloudUploadingAnimation);
  ...
  Future<void> uploadBanners() async {
    try {
      ...
      DFullScreenLoader.openLoadingDialog('Sit Tight! Your Banners are uploading. It may take a while...', DImages.cloudUploadingAnimation);
