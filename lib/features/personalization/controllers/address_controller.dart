...
class AddressController extends GetxController {
  ...
  addNewAddresses() async {
    try {
      // Start Loading
      DFullScreenLoader.openLoadingDialog('Storing Address...', DImages.docerAnimation);
      ...
      builder: (_) => SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const DSectionHeading(title: 'Select Address', showActionButton: false),
  ...
  updateAddress(AddressModel oldAddress) async {
    try {
      // Start Loading
      DFullScreenLoader.openLoadingDialog('Updating your Address...', DImages.docerAnimation);
