    ...
    return Scaffold(
      ...
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          backgroundColor: DHelperFunctions.isDarkMode(context) ? TColors.black : Colors.white,
          elevation: 0,
          indicatorColor: DHelperFunctions.isDarkMode(context) ? TColors.white.withValues(alpha: 0.9) : TColors.black.withValues(alpha: 0.9),
